...
public class TestSystem {
	private static EntityManagerFactory ENTITY_MANAGER_FACTORY = Persistence.createEntityManagerFactory("JEETut3");

	public static void main(String[] args) {
		
		addCustomer(1,"Ana","Anic");
		addCustomer(2,"Marko","Markovic");
		addCustomer(3,"Darko","Darkic");
		addCustomer(4,"Zarko","Zarkovic");
